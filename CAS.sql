...
CREATE TABLE Users (
  ...
  KRB5 ENUM('No','Yes') NOT NULL,
  LDAP ENUM('No','Yes') NOT NULL,
  PRIMARY KEY  (User),
...
CREATE TABLE GroupInfo (
  ...
  Owner INT(10) UNSIGNED ZEROFILL,
...
INSERT INTO GroupInfo VALUES (99, 'testers', 1, 1,
	'Test group, used during automated tests');

DROP TABLE IF EXISTS Permissions;
CREATE TABLE Permissions (
  ID MEDIUMINT UNSIGNED ZEROFILL PRIMARY KEY AUTO_INCREMENT,
  Client SMALLINT(3) UNSIGNED ZEROFILL NOT NULL DEFAULT '000',
  User INT(10) UNSIGNED ZEROFILL NOT NULL DEFAULT '0000000000',
  ...
  UNIQUE  (Client,User,GroupID,Resource,MatchKey),
  FOREIGN KEY (Client) REFERENCES Clients(ID),
  FOREIGN KEY (User) REFERENCES UserInfo(ID),
  FOREIGN KEY (GroupID) REFERENCES GroupInfo(ID)
) TYPE=MyISAM PACK_KEYS=1 CHECKSUM=1;
...
CREATE TABLE Clients (
  ...
  Default_Group SMALLINT(3) UNSIGNED ZEROFILL NOT NULL DEFAULT '000',
...
INSERT INTO Clients (ID, Name, Domain, Description, Cookie_Name, Timeout, 
	Default_Group) VALUES
	('000', 'Test client', '127.0.0.1', 'Client for use in "make test"',
	'CAS_TEST', 5, 99);
UPDATE Clients SET ID = 0 WHERE ID = 1;
